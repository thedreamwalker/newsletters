...
const cards = [
  {type: 'morning', supTitle: 'Перед рассветом', title: 'Утренний бухгалтер', description: 'Самые важные новости и события за день. Кратко, по делу, структурировано.', 
  image: morningImg, featureList: [{text: 'Новости для бухгалтеров, ИП и директора'}, {text: 'Подборка статей за день'},], count: 59342},
  {type: 'evening', supTitle: 'После заката', title: 'Ночной бухгалтер', description: 'Самая краткая газета о налогах и бухучете в мире — современная рассылка для чтения.', 
  image: eveningImg, featureList: [{text: 'Анализ, оценка и только самое главное'}, {text: 'Лучшие комменты юзеров в обзоре'},], count: 37480},
  {type: 'sale', supTitle: 'Раз в две недели', title: 'Ножницы скидок', description: 'Подборка самых выгодных и полезных спецпредложений от надежных компаний.', 
  ...
  {type: 'free', supTitle: 'По мере появления анонсов', title: 'Чемодан вебинаров', description: 'Подборка с анонсами бесплатных вебинаров на самые топовые темы при участии экспертов.', 
